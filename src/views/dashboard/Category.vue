        ...
        <Dashnav>
            <div class="container flex-grow-1">
                <div class="col-lg-12">
                    <h1>Category</h1>
                    <div class="mt-3"></div>
                    <div v-if="alert.show" :class="['alert', `alert-${alert.type}`]" role="alert" v-html="alert.message">
                    </div>
                    ...
                    <table id="category" class="table" style="width:100%">
                        ...
                        <tbody>
                            <tr v-for="category in categories" :key="category.id">
                                ...
                                <td>{{ category.name }}</td>
                                <td>
                                    <button @click="showEditCategoryModal(category)" class="btn btn-warning btn-sm"><i
                                ...
                                <div class="modal-body">
                                    <form @submit.prevent="submitCategory">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="author" v-model="category.name">
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
